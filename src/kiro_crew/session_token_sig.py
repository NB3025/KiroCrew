...
def publish_session_token(token: str, session_key: str) -> None:
    ...
    When the SEL trust root is unavailable the mapping is NOT published unsigned
    and any stale file is removed. That differs from the pid sidecar, which keeps
