...
def read_log(
    ...
    *,
    ...
    a directory or a dangling link is caught here and not at first read.
    """
    result = ReadResult()
...
def render_text(report_payload: dict[str, Any]) -> str:
    ...
    if not groups:
        return _render_empty(report_payload)
...
def report(
    *,
    ...
    return build_report(result, since=since, point=point)
