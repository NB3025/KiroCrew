...
class TestCli:
    ...
    def test_json_mode_prints_the_payload(self, _home: Path, capsys) -> None:
        from kiro_crew import cli_decisions
    ...
    def test_the_command_is_registered_and_listed(self) -> None:
        ...
        from kiro_crew import cli_decisions, cli_help

        parser = argparse.ArgumentParser()
        sub = parser.add_subparsers(dest="command")
        cli_decisions.register_decisions_parser(sub)
